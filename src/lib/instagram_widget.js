const InitInstagramWidget = async () => {
	try {
														...
														while (L < b) {
															...
															switch (g) {
																...
																default:
																	...
																	if (g >= 48 && g <= 57) {
																		g == 48 &&
																			((g = a.charCodeAt(L + 1)), g >= 48 && g <= 57) &&
																			N();
																		f = !1;
																		for (
																			;
																			L < b && ((g = a.charCodeAt(L)), g >= 48 && g <= 57);
																			L++
																		);
																		if (a.charCodeAt(L) == 46) {
																			...
																			for (
																				;
																				e < b && ((g = a.charCodeAt(e)), g >= 48 && g <= 57);
																				e++
																			);
																			e == L && N();
																			L = e;
						...
						function (a, b, c, d, e, f, g) {
							...
							function b(a, b, c) {
								...
								if (typeof e === 'function') {
									for (
										var f = arguments.length, g = new Array(f > 3 ? f - 3 : 0), j = 3;
										j < f;
										j++
									)
										g[j - 3] = arguments[j];
										...
										try {
											...
											try {
												...
												g == null &&
													...
													c != null &&
														c.length &&
														(d.extra[ES('Array', 'from', !1, c).toString().substring(0, 100)] =
															'args'));
					...
					__d(
						...
						function (a, b, c, d, e, f, g, h) {
							...
							var l = 'data-instgrm-captioned',
								...
								C = new RegExp(
									'^(' + w.source.replace(/^\^/, '').replace(/\$$/, '') + '/embed\\.js)'
								),
		...
		i.src =
			...
			encodeURIComponent(
				'{"error":"LOAD", "extra": {"name":"' +
					...
					'","revision":"1014147119","namespace":"FB","message":"' +
					e.message +
					'"}}'
			);
