<script>
const largura_viewbox = 64;
const largura_svg = 36;
const largura_circle = 32;
const color_fill = "var(--branco)";
export let url;
...
<div class="centralizar">
	...
	<div class="centralizado">
		<button
			...
			><svg
				viewBox="0 0 {largura_viewbox} {largura_viewbox}"
				width={largura_svg}
				height={largura_svg}
			>
				<circle cx={largura_circle} cy={largura_circle} r={largura_circle} fill="var(--secundary)"
				></circle>
				<path
		...
		<button
			on:click={openCenteredWindow('https://x.com/intent/tweet?url=' + url)}
			type="button"
			class="react-share__ShareButton"
			style="background-color:transparent;border:none;padding:0;font:inherit;color:inherit;cursor:pointer"
			><svg
		...
		<button
			on:click={openCenteredWindow('https://telegram.me/share/url?url=' + url)}
			type="button"
			class="react-share__ShareButton"
			style="background-color:transparent;border:none;padding:0;font:inherit;color:inherit;cursor:pointer"
			><svg
		...
		<button
			on:click={openCenteredWindow('mailto:?body=' + url)}
			type="button"
			class="react-share__ShareButton"
			style="background-color:transparent;border:none;padding:0;font:inherit;color:inherit;cursor:pointer"
			><svg
